...
class FirstFitSolver(FitSolver):
    ...
    def __init__(self, name="fisrt_fit", reusable=False, verbose=1, **kwargs):
...
class RandomFitSolver(Solver):
    ...
    def __init__(self, name="random_fit", reusable=False, **kwargs):
...
class NearestFitSolver(Solver):
    ...
    def __init__(self, name="nearest_fit", reusable=False, **kwargs):
