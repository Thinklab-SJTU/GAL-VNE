...
class MCTSSolver(Solver):
    ...
    def __init__(self,  computation_budget=3, exploration_constant=0.5, **kwargs):
        super(MCTSSolver, self).__init__(**kwargs)
        self.computation_budget = computation_budget
        self.exploration_constant = exploration_constant

    def solve(self, instance):
        v_net, p_net = instance['vn'], instance['pn']
        init_state = State(p_net, v_net, Controller, Counter)
        ...
        for v_node_id in range(v_net.num_nodes):
            ...
            if p_node_id == -1:
                ...
                return solution
            # place
            place_result = Controller.place(v_net, p_net, v_node_id, p_node_id, solution=solution)

        # link mapping
        link_mapping_result = Controller.link_mapping(v_net, p_net, solution=solution, 
                                                        shortest_method='bfs_shortest', k=5, inplace=True)
