...
class SubEnv(PlaceStepSubRLEnv):
    ...
    def _get_p_net_obs(self):
        ...
        # sum_bw
        e_attrs = self.p_net.get_edge_attrs(['resource'])
        ...
        # print("norm_node_attrs_data: ", norm_node_attrs_data.shape, "norm_link_aggr_attrs_data:", norm_link_aggr_attrs_data.shape)
