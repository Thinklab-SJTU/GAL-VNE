...
class VNERLEnv(gym.Env):
    ...
    def __init__(self, allow_rejection=False, allow_revocable=False, **kwargs):
        ...
        _, self.link_attrs_benchmark = self.obs_handler.get_edge_attrs_obs(self.p_net, link_attr_types=['extrema'], normalization=True)
    ...
    def generate_action_mask(self):
        candidate_nodes = Controller.find_candidate_nodes(self.v_net, self.p_net, self.curr_v_node_id, filter=self.selected_p_net_nodes)
        # candidate_nodes = Controller.find_feasible_nodes(self.p_net, self.v_net, self.curr_v_node_id, self.solution['node_slots'])
...
class BasicRLEnv(Environment, VNERLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        Environment.__init__(self, p_net, v_net_simulator, **kwargs)
...
class PlaceStepRLEnv(BasicRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        super(PlaceStepRLEnv, self).__init__(p_net, v_net_simulator, **kwargs)
    ...
    def step(self, action):
        ...
        if self.allow_rejection and p_node_id == self.p_net.num_nodes:
            ...
            node_place_result, node_place_info = Controller.place(self.v_net, self.p_net, self.curr_v_node_id, p_node_id, self.solution)
            ...
            if node_place_result and len(self.placed_v_net_nodes) == self.v_net.num_nodes:
                link_mapping_result = Controller.link_mapping(self.v_net, 
                                                                    self.p_net, 
                                                                    solution=self.solution, 
                                                                    sorted_v_edges=list(self.v_net.edges), 
...
class JointPRStepRLEnv(BasicRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        super(JointPRStepRLEnv, self).__init__(p_net, v_net_simulator, **kwargs)
    ...
    def step(self, action):
        ...
        if self.allow_rejection and p_node_id == self.p_net.num_nodes:
            ...
            assert p_node_id in list(self.p_net.nodes)
            place_and_route_result, place_and_route_info = Controller.place_and_route(
                                                                            self.v_net, 
                                                                            self.p_net, 
                                                                            self.curr_v_node_id, 
                                                                            p_node_id, 
...
class PairStepRLEnv(BasicRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        super(PairStepRLEnv, self).__init__(p_net, v_net_simulator, **kwargs)
...
class SolutionStepRLEnv(BasicRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        super(SolutionStepRLEnv, self).__init__(p_net, v_net_simulator, **kwargs)
...
class NodeSlotsStepRLEnv(BasicRLEnv):
    ...
    def __init__(self, p_net, v_net_simulator, **kwargs):
        super(NodeSlotsStepRLEnv, self).__init__(p_net, v_net_simulator, **kwargs)
