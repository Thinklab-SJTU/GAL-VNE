...
class GeneticAlgorithmSolver(MetaHeuristicSolver):
    ...
    def __init__(self, **kwargs):
        super(GeneticAlgorithmSolver, self).__init__(**kwargs)
        """
        """
        # basic methods
    ...
    def initialize(self, v_net, p_net):
        ...
        for chromosome in self.chromosomes:
            ...
            Controller.deploy_with_node_slots(v_net, p_net, node_slots, chromosome.solution, inplace=False, shortest_method=self.shortest_method, k_shortest=self.k_shortest)
    ...
    def conclusion(self):
        for c in self.chromosomes:
            Controller.deploy_with_node_slots(c.v_net, c.p_net, c.solution['node_slots'], c.solution, inplace=False, shortest_method=self.shortest_method, k_shortest=self.k_shortest)
