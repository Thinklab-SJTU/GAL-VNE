...
from solver.meta_heuristics.meta_heuristic_solver import Individual, MetaHeuristicSolver
...
class SimulatedAnnealingSolver(MetaHeuristicSolver):
    ...
    def __init__(self, **kwargs):
        super(SimulatedAnnealingSolver, self).__init__(**kwargs)
        """
        """
        # super parameters
    ...
    def initialize(self, v_net, p_net):
        ...
        for individual in self.individuals:
            ...
            Controller.deploy_with_node_slots(v_net, p_net, node_slots, individual.solution, inplace=False)
    ...
    def generate_neighor(self, individual):
        for i in range(self.max_attempt_times):
            ...
            if p_candicate != -1 and p_candicate != current_p_node:
                ...
                Controller.deploy_with_node_slots(individual.v_net, individual.p_net, individual.solution['node_slots'], individual.solution, inplace=False)
                break
